...
def read_sql_file(file_path):import pandas as pd
import re
from datetime import datetime
...
if __name__ == "__main__":
    ...
    if not df.empty:
        ...
        result_df.to_csv('youtube_comments_cama.csv', index=False, encoding='utf-8')
        db_config.write_df_to_table(result_df, "youtube_comments_cama", schema="CLEAN_SOPHIA")
